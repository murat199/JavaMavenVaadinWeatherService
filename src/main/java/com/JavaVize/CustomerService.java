...
public class CustomerService {
    ...
    public synchronized java.lang.String GetData() throws UnirestException {
        HttpResponse<java.lang.String> response = Unirest.get("http://api.openweathermap.org/data/2.5/weather?q=London&APPID=c93f19c6e0cd420387bbdc5fdc7e3b2d")
    ...
    public void ensureTestData() {
        if (findAll().isEmpty()) {
            ...
            for (String name : names) {
                ...
                c.setFirstName(java.lang.String.valueOf(split[0]));
                c.setLastName(java.lang.String.valueOf(split[1]));
